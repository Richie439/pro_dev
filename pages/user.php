            ...
            <div class="row text-white btn-lg text-center mt-5" style="background-color:RGB(51, 21, 15)">
                <span class="d-flex justify-content-center">
                    ...
                    <span class="col-1 ">
                        ...
                        <img src="data:image/jpg;base64,<?= base64_encode($_SESSION['photo']) ?>" class="rounded-circle" height="80" width="80" 
                        alt="">
                        <?php else: ?>
                ...
                <table class="table table-striped table-bordered border border-4 border-dark">
                    <thead class="text-white btn-lg text-center border border-4 border-dark" style="background-color:rgba(174, 115, 74, 1)">
                        <tr class="border border-4 border-dark">
                            ...
                            <th scope="col" class="border border-4 border-dark">Date d'inscription</th>
                        </tr>
                    </thead>
                        ...
                        <tr>
                            ...
                            if($aff){
                                echo '<tr>';
                                    ...
                                    echo '<td class="border border-4 border-dark">' . $data['date_heure'] . '</td>';
                            ...
                            for ($i = 0; $i < $limite; $i++) {
                                ...
                                while ($a = $reponse->fetch()) {
                                    ...
                                    echo '<td class="border border-4 border-dark">' . $a['date_heure'] . '</td>';
